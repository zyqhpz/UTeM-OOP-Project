...
public class ReportController {
	...
	public ArrayList<Double> retrieveData(Report report) throws ClassNotFoundException, SQLException {
		...
		String sql = "SELECT SUM(booking.amount), SUM(booking.hour) FROM booking JOIN court ON court.id = booking.court_id JOIN sport ON sport.id = court.sport_id WHERE booking.date LIKE '%"
				+ date + "%' GROUP BY sport.id";
	...
	public ArrayList<Double> retrieveTotalResevation(Report report) throws ClassNotFoundException, SQLException {
		...
		ArrayList<Double> data = new ArrayList<>();
		String sql = "SELECT COUNT(booking.id) FROM booking JOIN court ON court.id = booking.court_id JOIN sport ON sport.id = court.sport_id WHERE booking.date LIKE '%"
				+ date + "%' GROUP BY sport.id";
	...
	public ArrayList<Double> retrieveTotalReservationBySport(Report report)
